  ...
  return (
    <div>
      ...
      <ul>
        <li>
          <p>
            ...
            &quot;Our&quot; in this Agreement) refers to Fr0ntierX Inc., 3500 South Dupont Highway, Dover, 19901,
            Delaware.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to ID Token Demo, accessible from{" "}
            <a href="https://id-token-demo.fr0ntierx.xyz/" rel="external nofollow noopener" target="_blank">
              https://id-token-demo.fr0ntierx.xyz/
            </a>
          </p>
        </li>
        <li>
      ...
      <p>
        ...
        <a style={{ color: "blue" }} href="https://fr0ntierx.com">
          contact us
        </a>
      </p>
    </div>
